...
Chosen because one definition driving validation on both sides *and* the database makes it impossible for client and server to disagree on what values are valid.
